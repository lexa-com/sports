...
@Component({
  selector: 'app-premium-five-plus',
  templateUrl: './premium-five-plus.component.html',
  styleUrl: './premium-five-plus.component.css'
})
export class PremiumFivePlusComponent implements OnInit {
